              ...
              >
                ...
                <div className="card-body">
                  ...
                  <div className="card-actions mt-4">
                    <button className="btn border-2 border-[#002060] text-[#002060] hover:bg-white hover:border-[#9b1a1a] hover:text-[#9b1a1a] w-full">
                      {item.button}
                    </button>
                  </div>
                </div>
      ...
      <section className="py-10 px-4">
        <div className="bg-[#002060] text-white py-10 flex flex-col items-center text-center px-4 max-w-7xl mx-auto rounded-xl">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <button className="btn bg-white text-[#002060] border-none px-8 py-3 rounded-lg hover:bg-[#9b1a1a] hover:text-white">
            ...
            <a
              ...
              className="btn bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg 
                     hover:bg-white hover:text-[#9b1a1a] transition-all duration-200 flex items-center gap-2"
            >
              <FiPhone size={18} />
